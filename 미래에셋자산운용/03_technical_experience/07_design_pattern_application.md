...
> "저는 단순히 코드를 구현하는 것을 넘어, **클래스 폭발 문제 해결을 위해 디자인 패턴을 도입한 경험**이 있습니다. 특히 에잇퍼센트에서의 상환 스케줄 계산 로직이나 티맥스핀테크의 금융 상품 팩토리 설계 시, **스트래티지 패턴과 팩토리 패턴을 결합**하여 80개 이상의 로직을 확장성 있게 관리했습니다. 이러한 객체지향적 설계 역량은 미래에셋의 퀀트 플랫폼에서 다양한 투자 전략을 모듈화하고 관리하는 데 큰 기여를 할 수 있을 것입니다."

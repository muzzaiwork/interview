...
- **누적 수익률 곡선(Blue Line)**: 시간이 흐름에 따라 내 자산이 어떻게 변했는지 보여줍니다. 우상향할수록 우수한 전략입니다.
...
### 1. 성과 지표 (Example)
- **Final Return (4.5781)**: 투자 기간 종료 시 자산이 원금의 약 4.58배가 됨.
- **CAGR (0.1325)**: 연평균 약 13.25%의 복리 수익률 기록.
- **MDD (-0.3241)**: 고점 대비 최대 하락폭이 약 32.4%였음. (투자자의 인내심 척도)
- **Sharpe Ratio (0.8542)**: 위험 대비 수익의 효율성. 높을수록 우수한 전략.
